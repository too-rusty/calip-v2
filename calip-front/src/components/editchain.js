    ...
    render() {
        ...
        if (this.state.ccid === "NOTFOUND" ) {
            ...
            view = (
                ...
                <div>
                    <label>Title</label>
                    <input name="title" type="text" placeholder="Title" value={this.state.title}
                    onChange = { this.changeHandler.bind(this) } />
                </div>
                <div>
                    <label>About</label>
                    <input name="about" type="text" placeholder="About" value={this.state.about}
                    onChange = { this.changeHandler.bind(this) } />
                </div>
                <div>
                    <label>Tags( enter comma separated values (atmost 5) ) </label>
                    <input name="tag_str" type="text" placeholder="tags" value={this.state.tag_str}// TAGs TODO
                    onChange = { this.changeHandler.bind(this) } />
                </div>
