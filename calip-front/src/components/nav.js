        ...
        <div className="collapse navbar-collapse">
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item">
              ...
              <Link className="nav-link" to={"/profile/" + uname + "/reload"}>
                MyProfile
              </Link>
    ...
    return (
      ...
      <ReactBootstrap.Navbar className="navbar" bg="dark" expand="lg">
        <ReactBootstrap.Navbar.Brand href="#home">
          <img className="logo" src={logo} alt="calip" />
        ...
        <ReactBootstrap.Navbar.Collapse id="basic-navbar-nav">
          <ReactBootstrap.Nav className="mr-auto">
            ...
            <Link className="navbar-brand" to={"/cc"}>
              Explore
            </Link>
          </ReactBootstrap.Nav>
          <ReactBootstrap.Form inline>{buttons}</ReactBootstrap.Form>
